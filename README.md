...
There is another repository containing examples covering the concepts of the book [here](https://github.com/popalexandruvasile/angularjs-dotnet-book).
...
The example index page for this repository can be found [here](https://github.com/popalexandruvasile/rentthatbike/wiki)  
